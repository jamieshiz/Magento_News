<?php
class Irishtitan_News_VideosController extends Mage_Core_Controller_Front_Action
{
    public function indexAction() {
        ...
        $breadcrumbs->addCrumb('video', array('label'=>$content->title, 'title'=>$content->title));
        $block = $this->getLayout()->getBlock('video');
