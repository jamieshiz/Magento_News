...
class Irishtitan_News_ArticlesController extends Mage_Core_Controller_Front_Action
{
    public function indexAction() {
        ...
        $breadcrumbs->addCrumb('article', array('label'=>$content->title, 'title'=>$content->title));
        $block = $this->getLayout()->getBlock('article');
